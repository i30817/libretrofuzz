...
If the thumbnail server contains games from multiple releases for the system (like the ScummVM), be careful using this trick because it's easy to end up with 'slightly wrong' covers.
